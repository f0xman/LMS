    ...
    <meta name="author" content="@yield('author', 'MClass')">
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/fonts/elegant-icons/style.css') }}" media="screen">
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/fonts/iconfont/material-icons.css') }}" media="screen">
